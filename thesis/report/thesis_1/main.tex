...
There is a dire need of understanding the inner workings of a social structure to fully utilize the potential of the connections. This thesis aims to analyze different policies for the spreading of an idea in the society, to gain insight into methods to strike a balance in utility and cost incurred for the same. The author simulates an environment with two competing companies trying to attract the agents, and analyses the results to show that different policies of customer involvement are favoured under different circumstances.
}
