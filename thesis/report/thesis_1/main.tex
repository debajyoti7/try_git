...
There is a dire need of understanding the inner workings of a social structure to fully utilize the potential of the connections. This thesis aims to analyze different policies for the spreading of an idea in the society, to gain insight into methods to strike a balance in utility and cost incurred for the same.
}
